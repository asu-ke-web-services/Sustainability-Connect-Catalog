        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.opportunity.projects.invalid_open')</small>
                </h4>
            </div><!--col-->
            ...
            <div class="col">
                <table class="table table-striped table-bordered datatable">
                    ...
                    <tr>
                        ...
                        <th>@lang('labels.backend.opportunity.projects.table.listing_start_at')</th>
                        <th>@lang('labels.backend.opportunity.projects.table.listing_end_at')</th>
                        <th>@lang('Created')</th>
