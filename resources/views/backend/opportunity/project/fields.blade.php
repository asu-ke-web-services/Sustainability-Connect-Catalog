            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.backend.opportunity.projects.accept_application')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                            @lang('labels.backend.opportunity.projects.project_details')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.backend.opportunity.projects.locations')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                            @lang('labels.backend.opportunity.projects.applicant_details')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.backend.opportunity.projects.application_process')
                    </h4>
                </div><!--col-->
            </div><!--row-->
