...
@section('breadcrumb-links')
    @include('frontend.opportunity.project.includes.breadcrumb-links')
@endsection
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-7 pull-right">
                @include('frontend.opportunity.project.includes.header-buttons')
            </div><!--col-->
        </div><!--row-->
        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#organization" role="tab" aria-controls="organization" aria-expanded="true">Sponsoring Organization</a>
                    </li>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="overview" role="tabpanel" aria-expanded="true">
                        @include('frontend.opportunity.project.show.tabs.overview')
                    </div><!--tab-->

                    <div class="tab-pane" id="details" role="tabpanel" aria-expanded="true">
                        @include('frontend.opportunity.project.show.tabs.details')
                    </div><!--tab-->

                    <div class="tab-pane" id="organization" role="tabpanel" aria-expanded="true">
                        @include('frontend.opportunity.project.show.tabs.organization')
                    </div><!--tab-->

                    <div class="tab-pane" id="people" role="tabpanel" aria-expanded="true">
                        @include('frontend.opportunity.project.show.tabs.people')
                    </div><!--tab-->

                    <div class="tab-pane" id="attachments" role="tabpanel" aria-expanded="true">
                        @include('frontend.opportunity.project.show.tabs.attachments')
                    </div><!--tab-->

                    <div class="tab-pane" id="notes" role="tabpanel" aria-expanded="true">
                        @include('frontend.opportunity.project.show.tabs.notes')
                    </div><!--tab-->
                </div><!--tab-content-->
            </div><!--col-->
        </div><!--row-->
