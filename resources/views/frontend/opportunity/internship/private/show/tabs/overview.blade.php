<div class="col">
    <ul class="list-group">
        ...
        <li class="list-group-item"><span style="float: left; width: 200px;"><b>Project Starts:</b></span> {{ isset($internship->opportunity_start_at) ? $internship->opportunity_start_at->toFormattedDateString() : '' }} {{ isset($internship->opportunity_start_at) ? '(' . $internship->opportunity_start_at->diffForHumans() . ')' : '' }}</li>
        <li class="list-group-item"><span style="float: left; width: 200px;"><b>Project Ends:</b></span> {{ isset($internship->opportunity_end_at) ? $internship->opportunity_end_at->toFormattedDateString() : '' }} {{ isset($internship->opportunity_end_at) ? '(' . $internship->opportunity_end_at->diffForHumans() . ')' : '' }}</li>
