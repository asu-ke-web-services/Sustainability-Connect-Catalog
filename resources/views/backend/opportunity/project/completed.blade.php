        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.opportunity.projects.completed')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <table class="table table-striped table-bordered datatable">
                    ...
                    <tr>
                        ...
                        <th>@lang('labels.backend.opportunity.projects.table.last_updated')</th>
                    ...
                    @if ($projects->count())
                        @foreach ($projects as $project)
                            <tr>
                                ...
                                <td>{{ null !== $project->updated_at ? $project->updated_at->toDateString() : '' }}</td>
                                <td>{!! $project->action_buttons !!}</td>
                            </tr>
                        @endforeach
                    @else
                        <tr><td colspan="9"><p class="text-center">@lang('strings.backend.opportunity.projects.no_completed')</p></td></tr>
                    @endif
                    </tbody>
                </table>
            </div><!--col-->
