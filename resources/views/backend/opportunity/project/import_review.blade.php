            ...
            <div class="col">
                <table class="table table-striped table-bordered datatable">
                    ...
                    <tr>
                        ...
                        <th>{{ __('labels.backend.opportunity.projects.table.created_at') }}</th>
                    ...
                    @if ($projects->count())
                        @foreach ($projects as $project)
                            <tr>
                                ...
                                <td>{{ null !== $project->created_at ? $project->created_at->toFormattedDateString() : '' }}</td>
                                <td>{!! $project->action_buttons !!}</td>
                            </tr>
                        @endforeach
                    @else
                        <tr><td colspan="9"><p class="text-center">{{ __('strings.backend.opportunity.projects.no_import_review') }}</p></td></tr>
                    @endif
                    </tbody>
                </table>
            </div><!--col-->
