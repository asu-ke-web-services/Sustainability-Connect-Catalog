...
use SCCatalog\Repositories\Reference\OpportunityReviewStatusRepository;
...
class OpportunityReviewStatusRepositoryTest extends TestCase
{
    ...
    public function it_can_update_existing_opportunity_review_statuses()
    {
        ...
        $updatedOpportunityReviewStatus = $this->opportunityReviewStatusRepository->update($opportunityReviewStatus, $this->getValidOpportunityReviewStatusData([
