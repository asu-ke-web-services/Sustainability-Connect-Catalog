...
@section('content')
{{ html()->modelForm($internship, 'POST', route('frontend.opportunity.internship.private.private.attachment.store', $internship))->acceptsFiles()->class('form-horizontal')->open() }}
