...
trait ProjectRelationship
{
    ...
    {
        return $this->belongsTo(\SCCatalog\Models\Reference\BudgetType::class, 'budget_type_id');
    }
    ...
    {
        return $this->belongsTo(\SCCatalog\Models\Reference\OpportunityReviewStatus::class, 'review_status_id');
    }
