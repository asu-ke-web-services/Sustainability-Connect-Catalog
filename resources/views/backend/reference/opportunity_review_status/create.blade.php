...
@section('content')
{{ html()->form('POST', route('admin.reference.opportunity_review_status.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('Create New Opportunity Review Status')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
