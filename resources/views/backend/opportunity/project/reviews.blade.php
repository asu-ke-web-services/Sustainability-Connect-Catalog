        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.opportunity.projects.reviews')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <table class="table table-striped table-bordered datatable">
                    ...
                    @if ($projects->count())
                        ...
                        @endforeach
                    @else
                        <tr><td colspan="9"><p class="text-center">@lang('strings.backend.opportunity.projects.no_reviews')</p></td></tr>
                    @endif
                    </tbody>
                </table>
            </div><!--col-->
