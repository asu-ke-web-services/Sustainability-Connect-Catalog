...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_logout_url' => env('CAS_LOGOUT_URL', 'https://webapp4.asu.edu/myasu/Signout'),
    ...
    */
    'cas_redirect_path' => env('CAS_REDIRECT_PATH', 'https://catalog.local.gios.asu.edu/login/asu/callback'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'cas_version' => env('CAS_VERSION', '1.0'),
