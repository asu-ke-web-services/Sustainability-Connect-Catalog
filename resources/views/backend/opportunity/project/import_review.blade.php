...
@section ('title', __('labels.backend.opportunity.projects.management') . ' | ' . __('labels.backend.opportunity.projects.import_review'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.opportunity.projects.import_review')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <table class="table table-striped table-bordered datatable">
                    ...
                    <tr>
                        ...
                        <th>@lang('labels.backend.opportunity.projects.table.created_at')</th>
                    ...
                    @if ($projects->count())
                        @foreach ($projects as $project)
                            <tr>
                                ...
                                <td>{{ null !== $project->created_at ? $project->created_at->toDateString() : '' }}</td>
                                <td>{!! $project->action_buttons !!}</td>
                            </tr>
                        @endforeach
                    @else
                        <tr><td colspan="9"><p class="text-center">@lang('strings.backend.opportunity.projects.no_import_review')</p></td></tr>
                    @endif
                    </tbody>
                </table>
            </div><!--col-->
