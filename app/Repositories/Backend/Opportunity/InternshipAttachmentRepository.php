...
{
    /**
     * Create a new file attachment for an internship in the database.
     *
    ...
    /**
     * Update a file attachment for an internship in the database.
     *
     * @param Internship $internship
     * @param int $mediaId
     * @param array $data
    ...
    public function update(Internship $internship, Media $media, array $data)
    {
        return DB::transaction(function () use ($internship, $media, $data) {
            ...
            $media = $internship->updateMedia($media->id)
                // ->preservingOriginal()
                // ->usingName($data['name'])
    ...
    /**
     * Delete an attachment from an internship in the database.
     *
     * @param Internship $internship
     * @param Media $media
     * @return \Illuminate\Database\Eloquent\Model
