        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.opportunity.internships.import_review')</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
            ...
            <div class="col">
                <table class="table table-striped table-bordered datatable">
                    ...
                    @if ($internships->count())
                        ...
                        @endforeach
                    @else
                        <tr><td colspan="9"><p class="text-center">No Import Reviews Remaining</p></td></tr>
                    @endif
                    </tbody>
                </table>
            </div><!--col-->
