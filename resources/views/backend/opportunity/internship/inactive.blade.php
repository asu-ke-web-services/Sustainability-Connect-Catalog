        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">{{ __('labels.backend.opportunity.internships.inactive') }}</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @if ($internships->count())
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="9"><p class="text-center">{{ __('strings.backend.opportunity.internships.no_inactive') }}</p></td></tr>
                        @endif
                        </tbody>
                    </table>
                </div>
