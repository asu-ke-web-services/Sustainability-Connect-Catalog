            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.backend.opportunity.internships.accept_application')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                            @lang('labels.backend.opportunity.internships.internship_details')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.backend.opportunity.internships.locations')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                            @lang('labels.backend.opportunity.internships.applicant_details')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.backend.opportunity.internships.application_process')
                    </h4>
                </div><!--col-->
            </div><!--row-->
