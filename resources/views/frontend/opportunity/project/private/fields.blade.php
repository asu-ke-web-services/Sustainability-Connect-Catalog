            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.frontend.opportunity.projects.locations')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div id="card_application_listing" class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.frontend.opportunity.projects.accept_application')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                            @lang('labels.frontend.opportunity.projects.project_details')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                            @lang('labels.frontend.opportunity.projects.applicant_details')
                    </h4>
                </div><!--col-->
            </div><!--row-->
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        @lang('labels.frontend.opportunity.projects.application_process')
                    </h4>
                </div><!--col-->
            </div><!--row-->
