...
@section ('title', __('Opportunity Status') . ' Management | Create New ' . __('Opportunity Status'))

@section('content')
{{ html()->form('POST', route('admin.lookup.opportunity_status.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('Create New Opportunity Status') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
