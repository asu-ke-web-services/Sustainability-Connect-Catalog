...
@section ('title', __('{{modelName}}') . ' Management | Create New ' . __('{{modelName}}'))

@section('content')
{{ html()->form('POST', route('{{modelNameSingularLowerCase}}.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('Create New {{modelName}}') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('{{modelNameSingularLowerCase}}.index'), 'Cancel') }}
                </div><!--col-->
