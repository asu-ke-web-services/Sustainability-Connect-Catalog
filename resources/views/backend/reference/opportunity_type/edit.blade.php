...
@section('content')
{{ html()->modelForm($opportunityType, 'PATCH', route('admin.reference.opportunity_type.update', $opportunityType))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('Edit Opportunity Type')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
