    ...
    <div class="card">
        <div class="card-header">
            <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                <a href="{{ route('frontend.opportunity.project.private.attachment.add', $project) }}"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group" aria-label="Actions">
                                    <a href="{{ route('frontend.opportunity.project.private.attachment.edit', [$project, $attachment]) }}" class="btn btn-primary"><i class="fas fa-edit" data-toggle="tooltip" data-placement="top" title="@lang('buttons.general.crud.edit')"></i></a>
                                    {{-- <a href="{{ route('frontend.opportunity.project.private.attachment.delete', [$project, $attachment]) }}"
                                        data-method="delete"
