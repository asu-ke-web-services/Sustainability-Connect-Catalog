        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">@lang('labels.backend.organization.active')</small>
                </h4>
            </div><!--col-->
            ...
            <div class="col">
                <table class="table table-striped table-bordered datatable">
                    ...
                    @if ($organizations->count())
                        ...
                        @endforeach
                    @else
                        <tr><td colspan="9"><p class="text-center">@lang('strings.backend.organization.no_active')</p></td></tr>
                    @endif
                    </tbody>
                </table>
            </div><!--col-->
