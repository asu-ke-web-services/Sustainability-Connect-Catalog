...
@section ('title', __('labels.backend.opportunity.internships.management') . ' | ' . __('labels.backend.opportunity.internships.import_review'))
        ...
        <div class="row">
            <div class="col-sm-5">
                <h4 class="card-title mb-0">
                    ...
                    <small class="text-muted">{{ __('labels.backend.opportunity.internships.import_review') }}</small>
                </h4>
            </div><!--col-->
        </div><!--row-->
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        @if ($internships->count())
                            ...
                            @endforeach
                        @else
                            <tr><td colspan="9"><p class="text-center">{{ __('strings.backend.opportunity.internships.no_import_review') }}</p></td></tr>
                        @endif
                        </tbody>
                    </table>
                </div>
