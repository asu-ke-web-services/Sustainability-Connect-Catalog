...
@section ('title', __('Opportunity') . ' Management | Create New ' . __('Opportunity'))

@section('content')
{{ html()->form('POST', route('opportunity.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">{{ __('Create New Opportunity') }}</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('opportunity.index'), 'Cancel') }}
                </div><!--col-->
